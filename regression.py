...
#Now we intend to tell our machine to predict 0.5% more of the histrical data that we have. Basically, if we have 2000 values, we want the machine to be able to give us additional 20 values, in our case, prices.
